...
lblNum1 = ttk.Label(lblFrm1, text="ป้อนตัวเลขที่ 1 :").grid(
    column=0, row=0, padx=5, sticky="e")
lblNum2 = ttk.Label(lblFrm1, text="ป้อนตัวเลขที่ 2 :").grid(
    column=0, row=1, padx=5, sticky="e")
lblResult = ttk.Label(lblFrm1, text="ผลลัพธ์ :").grid(
    column=0, row=2, padx=5, sticky="e")
